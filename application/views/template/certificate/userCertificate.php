...
<body>
	...
	<div class="keikutsertaan">Keanggotaan IKA PC PMII Kota Malang</div>
	<div class="nomor">No Anggota : <?= $no_anggota ?></div>
	<div class="denganbangga">Dengan bangga diberikan kepada :</div>
	<div class="name"><?= $nama ?></div>
	<div class="melaksanakan">sebagai Anggota IKA PC PMII Kota Malang</div>
	<div class="kotattd">Malang, 20 Oktober 2021</div>
	<div class="kepalattd">Ketua IKA PC PMII Kota Malang</div>
