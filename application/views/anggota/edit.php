  ...
  <div class="row">
    <div class="col-12">
      ...
      <div class="card-header">
        <a href="<?=base_url('anggota') ?? $row->id ?>" class="btn btn-info float-right btn-sm"><i class="fas fa-backward"></i> Kembali</a>          
      </div>
        ...
        <?= form_open_multipart('')?>
          ...
          <div class="card-body">            
            ...
            <div>
              ...
              <a href="<?= site_url('anggota/hapusfoto/'.$row->id);?>"><small>Hapus foto?</small></a> 
            </div>
            <?php } else {  ?>             
            <div class="form-group">
              <label>Foto</label>
