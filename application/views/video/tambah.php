          ...
          <div class="card-body">
            <div class="form-group">
              ...
              <div class="input-group mb-3">
                ...
                <input type="text" class="form-control" name="judul" placeholder="Ex: Analisis Sosial 1" value="<?= set_value('judul');?>" required>
              </div>                            
            ...
            <div class="form-group">
              ...
              <div class="input-group mb-3">
                ...
                <input type="text" class="form-control" name="link" placeholder="Ex: TiVRRc-1WDY" value="<?= set_value('link');?>">
              </div>                            
